...
Another important part of the system is prediction history. ChemArch saves previous predictions so users can review past molecule pairs, strategies used, and outcomes. It also supports downloading a report of the prediction results for documentation or academic use.
